...
/*   Updated: 2023/04/26 17:37:24 by meshahrv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* DDA Algorithm
	...
	side_dist x & y is incremented with delta_dist x or y with the position of the player.
	When the ray has his a wall, the loop stops and we will know if we have hit the wall x or y side
	based on the side (0 or 1);
*/
...
/* Calculate Distance Projected on Camera
	...
	We use the distance of the camera plane and not the pos of the player to avoid fish eye effect.
	We check horizontally and vertically (side 0 or 1) the length of the ray projected
